#!/usr/bin/env python3
"""
generate_nwdaf_paper_drift_v2.py
=================================
...
Output: nwdaf_paper_drift_simulation_v2.parquet
"""
...
OUTPUT_FILE = SCRIPT_DIR / "nwdaf_paper_drift_simulation_v2.parquet"

SEED = 42                        # Reproducibility
N_CLIENTS = 3                    # Number of distinct clients / gNBs

# ── Client IP addresses ──────────────────────────────────────────────────────
CLIENT_IPS = ["10.100.0.1", "10.100.0.2", "10.100.0.3"]
...
def main():
    ...
    print("=" * 70)
    print("NWDAF Paper — Two-Regime AR(1) Drift Simulation (v2 — 10.100.0.x)")
